...
/**
 * _atoi - changes an input string to number
 * @str: pointer to the string to be converted.
 *
 * Return: ret. value is (num), the converted number
 */
int _atoi(char *str);
int _atoi(char *str)
{
...
/**
 * _exit_status - Exits with a specific status code
 * @input: The input string containing the status code
 * Return: void
 */
